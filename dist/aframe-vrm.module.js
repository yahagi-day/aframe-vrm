...
var BVHLoaderWrapper = class {
  ...
  convertBoneName(name) {
    return name = name.replace("Spine", "Spin"), name = name.replace("UpLeg", "UpperLeg"), name = name.replace("LeftLeg", "LeftLowerLeg"), name = name.replace("RightLeg", "RightLowerLeg"), name = name.replace("ForeArm", "UpperArm"), name = name.replace("LeftArm", "LeftLowerArm"), name = name.replace("RightArm", "RightLowerArm"), name = name.replace("LeftUpLeg", "LeftUpperLeg"), name = name.replace("RightUpLeg", "RightUpperLeg"), name = name.replace("LeftLeg", "LeftLowerLeg"), name = name.replace("RightLeg", "RightLowerLeg"), name.charAt(0).toLowerCase() + name.slice(1);
  }
